//--------------------------------------------------------------------------------------
// 
// WPF ShaderEffect HLSL -- HueEffect
// 
// Hue blend mode creates the result color by combining the luminance and saturation of
// the base color with the hue of the blend color.
//
//--------------------------------------------------------------------------------------
