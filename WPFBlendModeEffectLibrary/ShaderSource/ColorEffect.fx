//--------------------------------------------------------------------------------------
// 
// WPF ShaderEffect HLSL -- ColorEffect
// 
// Color blend mode keeps the brightness of the base color and applies both the hue and
...
float4 main(float2 uv : TEXCOORD) : COLOR
{
	...
	resultColor.rgb = BlendColor(inputColor.rgb, blendColor.rgb);
