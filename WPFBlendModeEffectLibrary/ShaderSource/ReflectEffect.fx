//--------------------------------------------------------------------------------------
// 
// WPF ShaderEffect HLSL -- ReflectEffect
//
//--------------------------------------------------------------------------------------
...
float4 main(float2 uv : TEXCOORD) : COLOR
{
	...
	resultColor.r = BlendReflectf(inputColor.r, blendColor.r);
	resultColor.g = BlendReflectf(inputColor.g, blendColor.g);
	resultColor.b = BlendReflectf(inputColor.b, blendColor.b);
