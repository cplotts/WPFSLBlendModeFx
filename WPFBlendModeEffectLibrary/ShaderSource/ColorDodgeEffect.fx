//--------------------------------------------------------------------------------------
// 
// WPF ShaderEffect HLSL -- ColorDodgeEffect
//
//--------------------------------------------------------------------------------------
...
float4 main(float2 uv : TEXCOORD) : COLOR
{
	...
	// R = Base / (1-Blend)
	resultColor.r = BlendColorDodgef(inputColor.r, blendColor.r);
	resultColor.g = BlendColorDodgef(inputColor.g, blendColor.g);
	resultColor.b = BlendColorDodgef(inputColor.b, blendColor.b);
