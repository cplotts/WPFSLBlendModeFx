//--------------------------------------------------------------------------------------
// 
// WPF ShaderEffect HLSL -- LuminosityEffect
// 
// Luminosity blend mode creates the result color by combining the hue and saturation
// of the base color with the luminance of the blend color.
//
//--------------------------------------------------------------------------------------
...
float4 main(float2 uv : TEXCOORD) : COLOR
{
	...
	resultColor.rgb = BlendLuminosity(inputColor.rgb, blendColor.rgb);
